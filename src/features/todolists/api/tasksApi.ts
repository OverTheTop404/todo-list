...
import type { TaskType, GetTasksResponse, UpdateTaskModel } from '@/features/todolists/api/tasksApi.types'
...
export const tasksApi = {
  ...
  createTask(payload: { todoListId: string; title: string }) {
    return instance.post<BaseResponse<{ item: TaskType }>>(`/todo-lists/${payload.todoListId}/tasks`, { title: payload.title })
  },
